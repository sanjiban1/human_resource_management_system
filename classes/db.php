...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "humanres_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "branch", "varname" => "humanres_at_localhost__branch", "altvarname" => "branch", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
			$dalTables[$conn->connId][] = array("name" => "employee", "varname" => "humanres_at_localhost__employee", "altvarname" => "employee", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
			$dalTables[$conn->connId][] = array("name" => "loan", "varname" => "humanres_at_localhost__loan", "altvarname" => "loan", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
			$dalTables[$conn->connId][] = array("name" => "notice", "varname" => "humanres_at_localhost__notice", "altvarname" => "notice", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
			$dalTables[$conn->connId][] = array("name" => "payroll", "varname" => "humanres_at_localhost__payroll", "altvarname" => "payroll", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
			$dalTables[$conn->connId][] = array("name" => "task assign", "varname" => "humanres_at_localhost__task_assign", "altvarname" => "task_assign", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "humanres_at_localhost__users", "altvarname" => "users", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		}
	}
