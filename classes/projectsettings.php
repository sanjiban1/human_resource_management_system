...
class ProjectSettings
{
	...
	function getConnId()
	{
		return $this->getTableData( ".connId" );
	}
...
function fillProjectEntites()
{
	...
	$projectEntities[ "employee" ] = array( "url" => "employee", "type" => 0 );
	$projectEntitiesReverse[ "employee" ] = "employee";
	$projectEntities[ "branch" ] = array( "url" => "branch", "type" => 0 );
	$projectEntitiesReverse[ "branch" ] = "branch";
	$projectEntities[ "task assign" ] = array( "url" => "task_assign", "type" => 0 );
	$projectEntitiesReverse[ "task_assign" ] = "task assign";
	$projectEntities[ "loan" ] = array( "url" => "loan", "type" => 0 );
	$projectEntitiesReverse[ "loan" ] = "loan";
	$projectEntities[ "notice" ] = array( "url" => "notice", "type" => 0 );
	$projectEntitiesReverse[ "notice" ] = "notice";
