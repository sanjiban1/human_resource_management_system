...
class ConnectionManager
{
	...
	{
		return $this->byId( "humanres_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "humanres_at_localhost";
		$data["connName"] = "humanres at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;humanres;;1"; //currently unused

		$this->_connectionsIdByName["humanres at localhost"] = "humanres_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "humanres";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=humanres;OPTION=3";
		// encription set
		...
		$connectionsData["humanres_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["users"] = "humanres_at_localhost";
		$connectionsIds["employee"] = "humanres_at_localhost";
		$connectionsIds["branch"] = "humanres_at_localhost";
		$connectionsIds["task assign"] = "humanres_at_localhost";
		$connectionsIds["loan"] = "humanres_at_localhost";
		$connectionsIds["notice"] = "humanres_at_localhost";
		$connectionsIds["payroll"] = "humanres_at_localhost";
