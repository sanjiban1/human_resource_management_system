...
$tdataGLOBAL[".pagesByType"] = my_json_decode( "{\"login\":[\"login\"],\"menu\":[\"menu\"]}" );
$tdataGLOBAL[".originalPagesByType"] = $tdataGLOBAL[".pagesByType"];
$tdataGLOBAL[".pages"] = types2pages( my_json_decode( "{\"login\":[\"login\"],\"menu\":[\"menu\"]}" ) );
$tdataGLOBAL[".originalPages"] = $tdataGLOBAL[".pages"];
$tdataGLOBAL[".defaultPages"] = my_json_decode( "{\"login\":\"login\",\"menu\":\"menu\"}" );
