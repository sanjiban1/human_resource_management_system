...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsusers["English"]["mob"] = "Mob";
	$fieldToolTipsusers["English"]["mob"] = "";
	$placeHoldersusers["English"]["mob"] = "";
...
$tdatausers[".connId"] = "humanres_at_localhost";
...
$tdatausers[".googleLikeFields"][] = "mob";
...
$tdatausers[".sqlHead"] = "SELECT id,  	fullname,  	email,  	password,  	mob,  	username";
...
//	Custom field settings
	...
	$fdata["GoodName"] = "mob";
	$fdata["ownerTable"] = "users";
	$fdata["Label"] = GetFieldLabel("users","mob");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdatausers["mob"] = $fdata;
		$tdatausers[".searchableFields"][] = "mob";
//	username
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 6;
...
$proto0["m_strFieldList"] = "id,  	fullname,  	email,  	password,  	mob,  	username";
