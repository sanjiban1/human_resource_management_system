...
class tDAL
{
	var $tblhumanres_at_localhost__branch;
	var $tblhumanres_at_localhost__employee;
	var $tblhumanres_at_localhost__loan;
	var $tblhumanres_at_localhost__notice;
	var $tblhumanres_at_localhost__payroll;
	var $tblhumanres_at_localhost__task_assign;
	var $tblhumanres_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "branch", "varname" => "humanres_at_localhost__branch", "altvarname" => "branch", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		$this->lstTables[] = array("name" => "employee", "varname" => "humanres_at_localhost__employee", "altvarname" => "employee", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		$this->lstTables[] = array("name" => "loan", "varname" => "humanres_at_localhost__loan", "altvarname" => "loan", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		$this->lstTables[] = array("name" => "notice", "varname" => "humanres_at_localhost__notice", "altvarname" => "notice", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		$this->lstTables[] = array("name" => "payroll", "varname" => "humanres_at_localhost__payroll", "altvarname" => "payroll", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		$this->lstTables[] = array("name" => "task assign", "varname" => "humanres_at_localhost__task_assign", "altvarname" => "task_assign", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "humanres_at_localhost__users", "altvarname" => "users", "connId" => "humanres_at_localhost", "schema" => "", "connName" => "humanres at localhost");
	}
